...
namespace CoreBot.Dialogs
{
    public class GenerateReport : CancelAndHelpDialog
    {
        ...
        public List<CustomerDetail> FetchCustomerData()
        {
            ...
            try
            {
                // Below commented code gets data from SQL DB table
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine($"DB not Available: {ex.Message}");
                // Optionally, log the error or rethrow it
                data = new List<CustomerDetail>
                {
                 new CustomerDetail { CustCode = "H123564",CustStatus = "ACTIVE",CustLivePosition = 10 },
                 new CustomerDetail { CustCode = "L365420",CustStatus = "INACTIVE",CustLivePosition = 0 },
                 new CustomerDetail { CustCode = "1256355",CustStatus = "ACTIVE",CustLivePosition = 1000 },
                 new CustomerDetail { CustCode = "1575755",CustStatus = "ACTIVE",CustLivePosition = 0 },
                 new CustomerDetail { CustCode = "4425222",CustStatus = "INACTIVE",CustLivePosition = 0 },
                 new CustomerDetail { CustCode = "4727575",CustStatus = "INACTIVE",CustLivePosition = 0 }
                };
            }
            return data;
        }
        public List<TradingBook> FetchTradingBookData()
        {
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine($"DB not available: {ex.Message}");
                // Optionally, log the error or rethrow it
                data = new List<TradingBook>
                {
                 new TradingBook { BookName = "ABCD",BookStatus = "ACTIVE",BookLivePosition = 10 },
                 new TradingBook { BookName = "EFGH",BookStatus = "ACTIVE",BookLivePosition = 1250 },
                 new TradingBook { BookName = "IJKL",BookStatus = "INACTIVE",BookLivePosition = 0 },
                 new TradingBook { BookName = "MNOP",BookStatus = "INACTIVE",BookLivePosition = 0 },
                 new TradingBook { BookName = "QRST",BookStatus = "ACTIVE",BookLivePosition = 0 },
                 new TradingBook { BookName = "UVWX",BookStatus = "INACTIVE",BookLivePosition = 0 }
                };
            }
            return data;
        }
