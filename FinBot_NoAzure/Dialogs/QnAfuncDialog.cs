...
{
    public class QnAfuncDialog : CancelAndHelpDialog
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpClientFactory _httpClientFactory;

        public QnAfuncDialog(IConfiguration configuration, IHttpClientFactory httpClientFactory)
            : base(nameof(QnAfuncDialog))
        {
        ...
        private async Task<DialogTurnResult> IntroStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            {
                Prompt = MessageFactory.Text("Please enter your question.")
            }, cancellationToken);
        }
        ...
        private async Task<DialogTurnResult> ActStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            {
                KnowledgeBaseId = _configuration["FuncProjectName"], 
            ...
            catch (Exception)
            {
                ...
                await stepContext.Context.SendActivityAsync(MessageFactory.Text("The Azure language service is currently unavailable. Please try again later."), cancellationToken);
            }
